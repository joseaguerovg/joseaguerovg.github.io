...
const Movies = () => {
    ...
    const getMovies = useCallback(async () => {
        const request = await theMovieDbApi.get<IMoviesResponse>(`discover/movie?api_key=${API_KEY}&sort_by=popularity.desc&language=${context.language}&page=${currentPage}`)
